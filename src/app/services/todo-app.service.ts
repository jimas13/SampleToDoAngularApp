...
export class TodoAppService {
  readonly baseURL = "https://apptestbenchsecondappservice.azurewebsites.net/api/ToDoItem";
  readonly authURL = "https://apptestbenchsecondappservice.azurewebsites.net/api/Authentication";
  list: TodoItem[]=[];
